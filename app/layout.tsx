      ...
      <body>
        ...
        <footer className="site-footer">
          <div className="social-row" aria-label="Social links">
            <a href="https://www.youtube.com/runplayback" aria-label="YouTube">
              <SocialIcon platform="youtube" />
            </a>
            <a href="http://instagram.com/runplayback" aria-label="Instagram">
              <SocialIcon platform="instagram" />
            </a>
            <a href="http://www.facebook.com/runplayback" aria-label="Facebook">
              <SocialIcon platform="facebook" />
            </a>
            <a href="http://twitter.com/runplayback" aria-label="X">
